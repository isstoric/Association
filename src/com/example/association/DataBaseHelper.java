...
public class DataBaseHelper extends SQLiteOpenHelper {
	...
	public DataBaseHelper(Context context, String databaseName, int typeOfAccess) {
	...
	public SQLiteDatabase openDataBase(int typeOfAccess) throws SQLException {
		String path = DB_PATH + DB_NAME;
		if (database == null) {
			createDataBase();
